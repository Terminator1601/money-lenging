...
//               <Link
//                 href="/lending/instant-personal-loan"
//                 className="block px-4 py-2 text-gray-700 hover:bg-blue-100"
//               >
//                 Instant Personal Loan
//               </Link>
//               <Link
//                 href="/lending/short-term-loan"
//                 className="block px-4 py-2 text-gray-700 hover:bg-blue-100"
//               >
//                 Short Term Loan
//               </Link>
//               <Link
//                 href="/lending/marriage-loan"
//                 className="block px-4 py-2 text-gray-700 hover:bg-blue-100"
//               >
//                 Marriage Loan
//               </Link>
//               <Link
//                 href="/lending/debt-consolidation-loan"
//                 className="block px-4 py-2 text-gray-700 hover:bg-blue-100"
//               >
//                 Debt Consolidation Loan
//               </Link>
//               <Link
//                 href="/lending/credit-card-repayment-loan"
//                 className="block px-4 py-2 text-gray-700 hover:bg-blue-100"
//               >
//                 Credit Card Repayment Loan
//               </Link>
//               <Link
//                 href="/lending/small-personal-loan"
//                 className="block px-4 py-2 text-gray-700 hover:bg-blue-100"
//               >
//                 Small Personal Loan
//               </Link>
...
//               >
//                 <path
//                   d="M12 12c2.7 0 5-2.3 5-5s-2.3-5-5-5-5 2.3-5 5 2.3 5 5 5zm0 2c-3.7 0-7 1.9-7 5v1h14v-1c0-3.1-3.3-5-7-5z"
//                 />
//               </svg>
//             </button>
