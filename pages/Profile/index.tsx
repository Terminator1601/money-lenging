...
import ProfileDetail from "../../components/ProfileDetail";
import LoanApplied from "../../components/LoanApplied";
import MerchantDashBoaard from "../../components/MerchantDashBoard"
...
const LoansApplied = () => <LoanApplied />;
const LoanHistory = () => <div>Loan History Content</div>;
const MerchantDashboard = () => <MerchantDashBoaard/>;
...
const ProfilePage: React.FC = () => {
  ...
  const renderMerchantSections = () => (
    <>
      ...
      <li>
        <button
          onClick={() => setActiveSection("Merchant Dashboard")}
          className={`w-full text-left p-2 rounded-md ${
            activeSection === "Merchant Dashboard"
              ? "bg-blue-600 text-white"
              : "text-gray-700 hover:bg-gray-100"
          }`}
        >
    ...
    <>
      ...
      <div className="max-w-5xl mx-auto py-8 px-4 flex space-x-4">
        ...
        <div className="w-1/3 bg-white p-4 rounded-lg shadow-md">
          ...
          <ul className="space-y-2">
            {role === "client" && renderClientSections()}
            {role === "merchant" && renderMerchantSections()}
          </ul>
        </div>
